...
// NzovuServer implements the gRPC QueueService interface directly
// using the storage layer without intermediate service abstractions
type NzovuServer struct {
...
// NewNzovuServer creates a new gRPC server instance
func NewNzovuServer(storage repository.Storage, schemaRegistry schema.Registry, logger *log.Logger) *NzovuServer {
	return &NzovuServer{
		storage:        storage,
		logger:         logger,
...
func (s *NzovuServer) CreateQueue(ctx context.Context, req *queueservice_pb.CreateQueueRequest) (*queueservice_pb.CreateQueueResponse, error) {
...
func (s *NzovuServer) DeleteQueue(ctx context.Context, req *queueservice_pb.DeleteQueueRequest) (*queueservice_pb.DeleteQueueResponse, error) {
...
func (s *NzovuServer) ListQueues(ctx context.Context, req *queueservice_pb.ListQueuesRequest) (*queueservice_pb.ListQueuesResponse, error) {
...
func (s *NzovuServer) GetQueueState(ctx context.Context, req *queueservice_pb.GetQueueStateRequest) (*queueservice_pb.GetQueueStateResponse, error) {
...
func (s *NzovuServer) PostMessage(ctx context.Context, req *queueservice_pb.PostMessageRequest) (*queueservice_pb.PostMessageResponse, error) {
...
func (s *NzovuServer) PostMessagesBulk(ctx context.Context, req *queueservice_pb.PostMessagesBulkRequest) (*queueservice_pb.PostMessagesBulkResponse, error) {
...
func (s *NzovuServer) GetNextMessage(ctx context.Context, req *queueservice_pb.GetNextMessageRequest) (*queueservice_pb.GetNextMessageResponse, error) {
...
func (s *NzovuServer) AcknowledgeMessage(ctx context.Context, req *queueservice_pb.AcknowledgeMessageRequest) (*queueservice_pb.AcknowledgeMessageResponse, error) {
...
func (s *NzovuServer) CancelMessage(ctx context.Context, req *queueservice_pb.CancelMessageRequest) (*queueservice_pb.CancelMessageResponse, error) {
...
func (s *NzovuServer) RenewMessageLease(ctx context.Context, req *queueservice_pb.RenewMessageLeaseRequest) (*queueservice_pb.RenewMessageLeaseResponse, error) {
...
func (s *NzovuServer) PeekQueueMessages(ctx context.Context, req *queueservice_pb.PeekQueueMessagesRequest) (*queueservice_pb.PeekQueueMessagesResponse, error) {
...
func (s *NzovuServer) SendMessageHeartBeat(ctx context.Context, req *queueservice_pb.SendMessageHeartBeatRequest) (*queueservice_pb.SendMessageHeartBeatResponse, error) {
...
func (s *NzovuServer) CreateSchedule(ctx context.Context, req *queueservice_pb.CreateScheduleRequest) (*queueservice_pb.CreateScheduleResponse, error) {
...
func (s *NzovuServer) DeleteSchedule(ctx context.Context, req *queueservice_pb.DeleteScheduleRequest) (*queueservice_pb.DeleteScheduleResponse, error) {
...
func (s *NzovuServer) GetSchedule(ctx context.Context, req *queueservice_pb.GetScheduleRequest) (*queueservice_pb.GetScheduleResponse, error) {
...
func (s *NzovuServer) ListSchedules(ctx context.Context, req *queueservice_pb.ListSchedulesRequest) (*queueservice_pb.ListSchedulesResponse, error) {
...
func (s *NzovuServer) GetScheduleHistory(ctx context.Context, req *queueservice_pb.GetScheduleHistoryRequest) (*queueservice_pb.GetScheduleHistoryResponse, error) {
...
func (s *NzovuServer) PauseSchedule(ctx context.Context, req *queueservice_pb.PauseScheduleRequest) (*queueservice_pb.PauseScheduleResponse, error) {
...
func (s *NzovuServer) ResumeSchedule(ctx context.Context, req *queueservice_pb.ResumeScheduleRequest) (*queueservice_pb.ResumeScheduleResponse, error) {
...
func (s *NzovuServer) ValidateCalendarSchedule(ctx context.Context, req *queueservice_pb.ValidateCalendarScheduleRequest) (*queueservice_pb.ValidateCalendarScheduleResponse, error) {
...
func (s *NzovuServer) PreviewCalendarSchedule(ctx context.Context, req *queueservice_pb.PreviewCalendarScheduleRequest) (*queueservice_pb.PreviewCalendarScheduleResponse, error) {
...
func (s *NzovuServer) GetDLQMessages(ctx context.Context, req *queueservice_pb.GetDLQMessagesRequest) (*queueservice_pb.GetDLQMessagesResponse, error) {
...
func (s *NzovuServer) RequeueFromDLQ(ctx context.Context, req *queueservice_pb.RequeueFromDLQRequest) (*queueservice_pb.RequeueFromDLQResponse, error) {
...
func (s *NzovuServer) DeleteFromDLQ(ctx context.Context, req *queueservice_pb.DeleteFromDLQRequest) (*queueservice_pb.DeleteFromDLQResponse, error) {
...
func (s *NzovuServer) PurgeDLQ(ctx context.Context, req *queueservice_pb.PurgeDLQRequest) (*queueservice_pb.PurgeDLQResponse, error) {
...
func (s *NzovuServer) GetDLQStats(ctx context.Context, req *queueservice_pb.GetDLQStatsRequest) (*queueservice_pb.GetDLQStatsResponse, error) {
...
func (s *NzovuServer) RegisterSchema(ctx context.Context, req *queueservice_pb.RegisterSchemaRequest) (*queueservice_pb.RegisterSchemaResponse, error) {
...
func (s *NzovuServer) GetSchema(ctx context.Context, req *queueservice_pb.GetSchemaRequest) (*queueservice_pb.GetSchemaResponse, error) {
...
func (s *NzovuServer) ListSchemas(ctx context.Context, req *queueservice_pb.ListSchemasRequest) (*queueservice_pb.ListSchemasResponse, error) {
...
func (s *NzovuServer) DeleteSchema(ctx context.Context, req *queueservice_pb.DeleteSchemaRequest) (*queueservice_pb.DeleteSchemaResponse, error) {
	if req == nil || req.GetSchemaId() == "" || req.GetVersion() < 0 {
		return nil, domainerror.New(domainerror.InvalidArgument, "schema id is required and version must be >= 0", nil)
	}
...
func (s *NzovuServer) ValidatePayload(ctx context.Context, req *queueservice_pb.ValidatePayloadRequest) (*queueservice_pb.ValidatePayloadResponse, error) {
	if req == nil || req.GetSchemaId() == "" || req.GetVersion() < 0 {
		return nil, domainerror.New(domainerror.InvalidArgument, "schema id is required and version must be >= 0", nil)
	}
