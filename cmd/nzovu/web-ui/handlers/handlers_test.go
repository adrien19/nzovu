...
func TestStatusClass(t *testing.T) {
	cases := []struct {
		...
		{"COMPLETED", "nzovu-badge nzovu-badge-good"},
		{"ERRORED", "nzovu-badge border-red-500/25 bg-red-500/10 text-red-300"},
		{"RUNNING", "nzovu-badge border-sky-500/25 bg-sky-500/10 text-sky-300"},
		{"unknown", "nzovu-badge nzovu-badge-muted"},
	}
	for _, c := range cases {
